...
class _DefaultInputState extends State<DefaultInput> {
  ...
  void initState() {
    ...
    _controller = TextEditingController(
        text: (widget.text?.isNotEmpty ?? false) ? widget.text : null);
    super.initState();
  }
          ...
          decoration: InputDecoration(
            ...
            labelStyle: widget.labelStyle ??
                TextStyle(
                  fontWeight: FontWeight.w400,
                  fontSize:
                      _focus.hasFocus || _controller.value.text != '' ? 13 : 17,
                  color: _focus.hasFocus || _controller.value.text != ''
                      ? AppColors.gray5
                      : AppColors.inputHint,
                  height: _focus.hasFocus || _controller.value.text != ''
                      ? 18 / 13
                      : 24 / 17,
                ),
  ...
  Widget _buildErrorMessage() => Row(
        children: [
          SvgPicture.asset(Assets.images.error.path, height: 16, width: 16),
